...
public class AddRetrication2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addretrication2);

        db1=openOrCreateDatabase("AppTime",Context.MODE_PRIVATE,null);
        db1.execSQL("create table if not exists AppUse (PackageName varchar(900),Utime varchar(900))");
        ...
        et1=(EditText)findViewById(R.id.time) ;

        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String time=et1.getText().toString();
                ContentValues cv1= new ContentValues();
                cv1.put("PackageName",packageName );
                cv1.put("Utime",time);
                db1.insert("AppUse",null,cv1);
                Toast.makeText(AddRetrication2.this, "Restriction Added Sucessfully", Toast.LENGTH_SHORT).show();
            }
        });
